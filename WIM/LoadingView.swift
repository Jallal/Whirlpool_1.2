...
//  Whirlpool-iOS
//
//  Created by Jallal Elhazzat on 11/25/15.
...
public class  LoadingView: UIView {
    ...
    //
    public class func show(title: String, animated: Bool = true) -> LoadingView {
    ...
    //
    public class func showWithDelay(delay: Double, title: String, animated: Bool = true) -> LoadingView {
        let spinner = LoadingView.sharedInstance
        
        spinner.showWithDelayBlock = {
            LoadingView.show(title, animated: animated)
        }
    ...
    public func updateFrame() {
        let window = UIApplication.sharedApplication().windows.first!
        LoadingView.sharedInstance.frame = window.frame
    }
