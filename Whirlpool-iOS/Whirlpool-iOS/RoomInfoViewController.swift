...
class RoomInfoViewController: UIViewController,UIWebViewDelegate {
    ...
    @IBAction func favoriteButton(sender: UIButton) {
        let alert = UIAlertController(title: _room.GetName(), message: "New Favorite Added", preferredStyle: .Alert)
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        freeBusyTimesGetRequest(_room.GetEmail())
    ...
    func saveFavoriteRoom(room: RoomData){
        ...
        favoriteRoom.setValue(room.GetName(), forKey: "roomName")
        favoriteRoom.setValue(room.GetEmail(), forKey: "roomEmail")
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "bookRoomSeg" {
            ...
            eventVC.guest = _room.GetEmail()
            eventVC.location = _room.GetName()
